	...
	render() {
		return (
			<div>
				...
				<>
					<div
						className='cats-display-wrapper'
						...
						<ListGroup className='cat-wrapper' style={{ width: '300px' }}>
							...
							<div id='post-description-wrapper'>
								...
								<div>
									...
									<h3>
										{' '}
										<a id='icons' href='https://www.linkedin.com/in/mabrouk10/'>
											{' '}
											<FaLinkedin />{' '}
										</a>
										<a id='icons' href='https://github.com/mabrouk10'>
											{' '}
											<FaGithub />{' '}
										</a>
									</h3>
							...
							<div id='post-description-wrapper'>
								...
								<div>
									...
									<h3>
										...
										<a
											id='icons'
											href='https://www.linkedin.com/in/alejandroestrada617/'
										>
											{' '}
											<FaLinkedin />{' '}
										</a>
										<a id='icons' href='https://github.com/aestrada611'>
											{' '}
											<FaGithub />{' '}
										</a>
									</h3>
							...
							<div id='post-description-wrapper'>
								...
								<div>
									...
									<h3>
										<a
											id='icons'
											href='https://www.linkedin.com/in/priscilap-developer/'
										>
											{' '}
											<FaLinkedin />{' '}
										</a>

										<a id='icons' href='https://github.com/priscila2294'>
											{' '}
											<FaGithub />{' '}
										</a>
									</h3>
